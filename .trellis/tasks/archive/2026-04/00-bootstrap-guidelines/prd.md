...
- [x] Fill guidelines for core/doh_proxy
- [x] Add code examples
...
### Package: core/doh_proxy (`spec/core/doh_proxy/`)

- Backend guidelines: `.trellis/spec/core/doh_proxy/backend/`

- Frontend guidelines: `.trellis/spec/core/doh_proxy/frontend/`
